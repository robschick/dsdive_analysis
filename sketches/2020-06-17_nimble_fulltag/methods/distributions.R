...
system(paste(
  ...
  paste('CXXFLAGS=', '"',
        paste('-I', 
              ...
              sep = '', collapse = ' '), 
        '"', sep = ''),
  'sketches/2020-06-17_nimble_fulltag/exp_symtools.cpp',
  sep = ' '
))
...
decomposeGeneratorCpp = nimbleExternalCall(
  ...
  returnType = void(), 
  Cfun = 'expm_cpp', 
  headerFile = file.path(getwd(), 'sketches/2020-06-17_nimble_fulltag', 
                         'exp_symtools.h'), 
  oFile = file.path(getwd(), 'sketches/2020-06-17_nimble_fulltag', 
                    'exp_symtools.o')
)
